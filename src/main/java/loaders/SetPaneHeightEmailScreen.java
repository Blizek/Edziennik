...
public class SetPaneHeightEmailScreen {
    public static void setPaneHeight(AnchorPane settingPane, AnchorPane secondPane, AnchorPane paneForPeriods, ImageView settingPaneIcon, boolean isReceivedPane, AnchorPane listOfMailsPane, AnchorPane paneForMail) {
        if (settingPane.getPrefHeight() == 198) {
            ...
            AddPeriodsEmailScreen.addPeriods(paneForPeriods, String.valueOf(isReceivedPane), listOfMailsPane, paneForMail);
