...
public class CreateMailsPane {
    ...
    public static void create(List<Email> emails, AnchorPane paneToAdd, List<Text> texts, AnchorPane mailTextPane) throws SQLException {
        ...
        for (int i = 0; i < emails.size(); i++) {
            ...
            EventHandler<MouseEvent> getThisEmail = e -> {
                ...
                try {
                    ...
                    FillMailText.fill(emailToOpen, texts, mailTextPane);
