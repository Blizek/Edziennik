...
public class SettingManageView {
    public static void set(String buttonID, ScrollPane scroll, AnchorPane scrollAnchor, Text pageInformation) throws SQLException {
        switch (buttonID) {
            case "marks" -> MarksManageScreenView.view(scroll, scrollAnchor, pageInformation);
